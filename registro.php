...
if ($_POST['selectrol'] == 1) {
	...
	$sql = "INSERT INTO conductor (cedula, nombres, apellidos, telefono, departamento, ndpto, municipio, nmpio, direccion, correo, tpvehiculo, licencia, soat, tecmeca, rol, politicadatos, cantviajes) VALUES ($cedula, '$name', '$apellidos', '$telefono', 0, '0', 0, '0', 'dcion', '$email', 'tp', 1, 1, 1, $rol, 'si', 0)";
	...
	$sql2 = "INSERT INTO cliente (cedula, nit, razonsocial, nombres, apellidos, direccion, departamento, ndpto, municipio, nmpio, telefono, correo, rol, politicadatos) VALUES ($cedula, '$cedula', '0000', '$name', '$apellidos', 'dcion', 0, '0', 0, '0', '$telefono', '$email', $rol, 'si')";
